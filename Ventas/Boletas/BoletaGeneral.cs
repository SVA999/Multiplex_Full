...
/// <summary>
/// BoletaGeneral - General admission ticket class
/// </summary>
public class BoletaGeneral : IBoletaFuncion
{
    ...
    public BoletaGeneral(long id, Espectador espectador, Funcion funcion, Silla silla, decimal valor)
    {
    ...
    public string ObtenerInfo() => $"[Boleta General] ID: {Id} | Espectador: {Espectador.Nombre} | Función: {Funcion.Codigo} | Valor: {Valor:C}";
